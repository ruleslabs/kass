...
contract TestSetup_KassERC1155 is KassTestBase {
    ...
    function setUp() public override {
        _kassERC1155.initialize(abi.encode(KassUtils.encodeTightlyPacked(L2_TOKEN_URI)));
...
contract Test_KassERC1155 is TestSetup_KassERC1155 {
    ...
    function test_1155_CannotInitializeTwice() public {
        ...
        assertEq(_kassERC1155.uri(0), string(KassUtils.encodeTightlyPacked(L2_TOKEN_URI)));
    }
